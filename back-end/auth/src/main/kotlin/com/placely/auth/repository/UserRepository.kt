...
interface UserRepository : JpaRepository<UserEntity, Long>, UserRepositoryCustom {
     ...
     */
    fun findByEmailAndIsDeleted(email: String, isDeleted: String = "N"): Optional<UserEntity>
    ...
    fun findByUsernameOrEmailForLogin(@Param("loginId") loginId: String): Optional<UserEntity>
