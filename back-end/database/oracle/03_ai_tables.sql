...
-- 기본 세그먼트 데이터 삽입
INSERT INTO AI_CUSTOMER_SEGMENTS (SEGMENT_ID, SEGMENT_NAME, DESCRIPTION, CRITERIA) VALUES 
(SEQ_AI_CUSTOMER_SEGMENTS.NEXTVAL, 'VIP 고객', '월 구매액 50만원 이상', '{"monthly_amount": {"min": 500000}}'),
(SEQ_AI_CUSTOMER_SEGMENTS.NEXTVAL, '단골 고객', '월 3회 이상 방문', '{"monthly_visits": {"min": 3}}'),
(SEQ_AI_CUSTOMER_SEGMENTS.NEXTVAL, '신규 고객', '첫 방문 후 1개월 이내', '{"days_since_first_visit": {"max": 30}}'),
(SEQ_AI_CUSTOMER_SEGMENTS.NEXTVAL, '이탈 위험 고객', '최근 30일간 방문 없음', '{"days_since_last_visit": {"min": 30}}');
