...
CREATE TABLE POS_OWNERS (
    ...
    PHONE           VARCHAR2(20),
    STATUS_CODE     VARCHAR2(20)    DEFAULT 'ACTIVE' CHECK (STATUS_CODE IN ('ACTIVE', 'INACTIVE')),
...
CREATE TABLE POS_STORES (
    ...
    STATUS_CODE     VARCHAR2(20)    DEFAULT 'ACTIVE' CHECK (STATUS_CODE IN ('ACTIVE', 'INACTIVE', 'MAINTENANCE')),
    CREATED_AT      TIMESTAMP       DEFAULT CURRENT_TIMESTAMP,
    UPDATED_AT      TIMESTAMP       DEFAULT CURRENT_TIMESTAMP,
...
CREATE TABLE POS_SALES (
    ...
    STATUS_CODE     VARCHAR2(20)    DEFAULT 'COMPLETED' CHECK (STATUS_CODE IN ('COMPLETED', 'CANCELLED', 'REFUNDED')),
    CREATED_AT      TIMESTAMP       DEFAULT CURRENT_TIMESTAMP,
    FOREIGN KEY (STORE_ID) REFERENCES POS_STORES(STORE_ID)
);
...
CREATE TABLE POS_PAYMENTS (
    ...
    STATUS_CODE     VARCHAR2(20)    DEFAULT 'COMPLETED' CHECK (STATUS_CODE IN ('COMPLETED', 'CANCELLED')),
    FOREIGN KEY (SALE_ID) REFERENCES POS_SALES(SALE_ID)
);
