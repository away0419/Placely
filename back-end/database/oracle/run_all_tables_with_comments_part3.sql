...
values (1, 'admin', 'admin@admin.com', 'V5FYuDVBp+/xqiE6+y51+5htVY0LG7mTemTyItWxb+M=', '010-3155-0419','홍길동', 1 ,SYSDATE);
...
INSERT INTO AUTH_USER_ROLES (USER_ID, ROLE_ID, GRANTED_AT, GRANTED_BY) VALUES (1, 1, SYSDATE, 1);
-- POS 서비스 기본 데이터
